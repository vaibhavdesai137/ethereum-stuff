...
geth --networkid 4224 --mine --datadir "./" --nodiscover --rpc --rpcport "8545"  --rpccorsdomain "*" --port "30303" --nat "any" --rpcapi eth,web3,personal,net --unlock 0 --password ./password.sec --ipcpath "~/Library/Ethereum/geth.ipc"
